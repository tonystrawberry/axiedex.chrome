 ...
 */
function putOption(key: OptionKey, value: any) {
 ...
 */
function putOptions(options: Options) {
 ...
 */
function getOption(key: OptionKey, callback: any) {
 ...
 */
function resetOptions(options: Options) {
